...
/**
 * This is the model class for table "figure_rubric".
 *
 * The followings are the available columns in table 'figure_rubric':
 * @property integer $id
 ...
 */
class BaseFigureRubric extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BaseFigureRubric the static model class
	 */
