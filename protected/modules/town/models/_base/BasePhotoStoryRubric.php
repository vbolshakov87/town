...
/**
 * This is the model class for table "photo_story_rubric".
 *
 * The followings are the available columns in table 'photo_story_rubric':
 * @property integer $id
 ...
 */
class BasePhotoStoryRubric extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BasePhotoStoryRubric the static model class
	 */
