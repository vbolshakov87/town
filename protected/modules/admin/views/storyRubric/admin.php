...
$this->breadcrumbs=array(
	'Рубрики исторических материалов',
);

$this->menu=array(
	array('label'=>'Исторических материалы на сайте', 'url'=>Yii::app()->createUrl('figure/index'), 'linkOptions'=>array('target'=>'_blank')),
...
<h1>Рубрикатор исторических материалов</h1>
<p><?=CHtml::link('Добавить рубрику', Yii::app()->createUrl('admin/storyRubric/create'), array('class' => 'btn btn-small btn-primary')); ?></p>
