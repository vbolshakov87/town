	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="images">
            ...
            <div class="form-group row <?if (!empty($model->errors['image_top_3'])) :?> error<?endif;?>">
                ...
                <div class="col-sm-10">
                    <?$this->widget('ImageCropWidget', array('attribute'=>'image_top_3', 'model' => $model, 'cropFrom' => 'image', 'cropFromType' => 'story/detail', 'minWidth' => 630, 'minHeight' => 391, 'previewType' => 'story/topIndex')); ?>
                </div>
            </div>
            <div class="form-group row <?if (!empty($model->errors['image_top_1'])) :?> error<?endif;?>">
                ...
                <div class="col-sm-10">
                    <?$this->widget('ImageCropWidget', array('attribute'=>'image_top_1', 'model' => $model, 'cropFrom' => 'image', 'cropFromType' => 'story/detail', 'minWidth' => 300, 'minHeight' => 189, 'previewType' => 'story/top')); ?>
                </div>
            </div>
		</div>
