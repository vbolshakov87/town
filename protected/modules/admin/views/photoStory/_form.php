	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="images">
			...
			<div class="form-group row <?if (!empty($model->errors['image_top_3'])) :?> error<?endif;?>">
				...
				<div class="col-sm-10">
					<?$this->widget('ImageUploadWidget', array('attribute'=>'image_top_3', 'model' => $model, 'type'=>'photoStory_admin/form')); ?>
				</div>
			</div>
			...
			<div class="form-group row <?if (!empty($model->errors['image_top_1'])) :?> error<?endif;?>">
				...
				<div class="col-sm-10">
					<?$this->widget('ImageUploadWidget', array('attribute'=>'image_top_1', 'model' => $model, 'type'=>'photoStory_admin/form')); ?>
				</div>
			</div>
