...
class ContentBlockController extends AdminController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ContentBlock']))
		{
			...
			if($model->save()) {
				UserActionLog::addTolog('contentBlock', $model->id, UserActionLog::ACTION_CREATE);
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['ContentBlock']))
		{
			...
			if($model->save()) {
				...
				UserActionLog::addTolog('contentBlock', $model->id, UserActionLog::ACTION_UPDATE);
				$this->redirect($this->formRedirectUrl($model));
			}
		}
	...
	public function actionDelete($id)
	{
		...
		if (Yii::app()->getUser()->isAdmin()) {
			$model->delete();
			CacheTaggedHelper::deleteByTags(array($model->name));
			UserActionLog::addTolog('contentBlock', $id, UserActionLog::ACTION_DELETE);
